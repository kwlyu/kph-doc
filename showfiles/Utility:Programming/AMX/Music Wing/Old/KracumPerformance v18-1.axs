...
dvSWITCH	=	5001:1:0	// Extorn IN-1608
...
{
    send_string dvSWITCH, "itoa(s),'*',itoa(d),'!'"
    routedVideo[d] = s
...
{  //Lens Position 1
	...
	send_string dvPROJ, "'POPLP 01',13"
...
{  //Lens Position 2
	...
	send_string dvPROJ, "'POPLP 02',13"
